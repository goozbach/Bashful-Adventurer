...
<xsl:stylesheet
	...
	<xsl:template match="xhtml:head">
		...
		<meta name="controlVis" content="hidden" />
		<link rel="stylesheet" href="file://home/hero/.resources/s5/ui/{$theme}/slides.css" type="text/css" media="projection" id="slideProj" />
		<link rel="stylesheet" href="file://home/hero/.resources/s5/ui/default/outline.css" type="text/css" media="screen" id="outlineStyle" />
		<link rel="stylesheet" href="file://home/hero/.resources/s5/ui/default/print.css" type="text/css" media="print" id="slidePrint" />
		<link rel="stylesheet" href="file://home/hero/.resources/s5/ui/default/opera.css" type="text/css" media="projection" id="operaFix" />
		<script src="file://home/hero/.resources/s5/ui/default/slides.js" type="text/javascript"></script>
		</head>
	</xsl:template>
	...
	<xsl:template match="xhtml:body">
		<body>
			...
			<div id="controlsOuter">
  				<div id="controls">
    				<form action="#controlForm" id="controlForm" >                    
      				<div id="navLinks"> 
        				<a accesskey="n" id="show-notes" class="controlLink" href="#showNotes" title="Show Notes"><xsl:text disable-output-escaping="yes"><![CDATA[&equiv;]]> </xsl:text></a>
        				<a accesskey="t" id="toggle" class="controlLink" href="#toggle">&#216;</a>
        				<a accesskey="z" id="prev" class="controlLink" href="#prev"><xsl:text disable-output-escaping="yes"><![CDATA[&laquo;]]> </xsl:text></a>
        				<a accesskey="x" id="next" class="controlLink" href="#next"><xsl:text disable-output-escaping="yes"><![CDATA[&raquo;]]> </xsl:text></a>
        				<div id="navList"><select id="jumplist" onchange=""></select></div>
      				</div>
    				</form>
  				</div>
			</div>
			...
			<div id="whiteoutbox"><!-- DO NOT EDIT --></div>
			<div id="blackoutbox"><!-- DO NOT EDIT --></div>
			<div id="footer">
